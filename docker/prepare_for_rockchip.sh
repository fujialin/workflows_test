...
function download_rga() {
  ...
  mv rk-rga.tar.gz ${CODE_DIR}/rk/rk-rga.tar.gz
...
download_rknn() {
  ...
  mv rknn.tar.gz ${CODE_DIR}/rk/rknn.tar.gz
...
download_rknnrt() {
  ...
  mv rknnrt.tar.gz ${CODE_DIR}/rk/rknnrt.tar.gz
...
download_rkmpp() {
  ...
  mv rkmpp.tar.gz ${CODE_DIR}/rk/rkmpp.tar.gz
...
download_thirdparty_rk() {
  ...
  cd ${CODE_DIR}/rk_3rd
  download http://download.modelbox-ai.com/third-party/aarch64/rk/rk-rga.tar.gz
  download http://download.modelbox-ai.com/third-party/aarch64/rk/rknn.tar.gz
  download http://download.modelbox-ai.com/third-party/aarch64/rk/rknnrt.tar.gz
